    ...
    <div>
      ...
      <div className="max-w-2xl">
        <motion.div
          ...
          transition={{ delay: 0.1 }}
        >
          <Card className="bg-[#020725]/40 border-[#bdccd4]/10 backdrop-blur-md overflow-hidden">
               ...
               <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
                 ...
                 <div className="space-y-5 md:space-y-6">
                   ...
                   <div className="space-y-3">
                     <div className="flex items-center gap-2 text-[#bdccd4]/70 text-sm">
                       <Cpu className="w-4 h-4 text-[#24ab94]" />
                   ...
                   <div className="space-y-3">
                     <div className="flex items-center gap-2 text-[#bdccd4]/70 text-sm">
                       <HardDrive className="w-4 h-4 text-[#24ab94]" />
                   ...
                   <div className="space-y-3">
                     <div className="flex items-center gap-2 text-[#bdccd4]/70 text-sm">
                       <Box className="w-4 h-4 text-[#24ab94]" />
                         ...
                         <button
                           ...
                           className={cn(
                             ...
                             formData.image === opt.value
                               ? 'bg-[#24ab94]/10 border-[#24ab94] text-[#24ab94]'
                               : 'bg-[#010311] border-[#bdccd4]/20 text-[#bdccd4]/70 hover:border-[#bdccd4]/40'
                           )}
                         >
                           {formData.image === opt.value && (
                             <motion.div
                               layoutId="image-active"
                               className="absolute inset-0 border-2 border-[#24ab94] rounded-lg"
                 ...
                 <div className="pt-4 md:pt-6 flex flex-col sm:flex-row gap-3 border-t border-[#bdccd4]/10">
                   <Button 
                     type="submit" 
                     disabled={creating}
                   ...
                   <Button 
                     ...
                     variant="ghost"
                     onClick={() => navigate('/admin')}
                     className="text-[#bdccd4]/60 hover:text-[#bdccd4] hover:bg-[#bdccd4]/5 w-full sm:w-auto"
                   >
                     Cancel
                   </Button>
                 </div>
